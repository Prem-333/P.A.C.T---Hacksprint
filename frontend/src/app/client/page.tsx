...
export default function ClientPage() {
  const { user, balances, escrows, transactions, isLoading, fetchData, handleLogout } = useDashboard("client");
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[var(--color-background)]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <Header
          viewTitle="🏭 Client Dashboard — Bharath"
          viewDescription="Send payments and create DvP escrows for raw material procurement"
          userName={user.name}
          userRole={user.role}
